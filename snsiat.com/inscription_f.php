...
?>
		...
		<div id="content">
			...
			<div class="content_block content_bg2 anchor" id="login">
				...
				<div class="content_block_title_white">Inscription Fournisseur</div>
					...
					<div class="content_block_half_white">
						<div class="content_block_internal_info">
							...
							<form id="register_form">
							    ...
							    <input id="form_btn" type="reset" name="reset" class="main_menu_item" value="ANNULER" id="reset_btn">
							</form>
							<div class="content_block_info">
								<h4>
									Déjà un compte sur SN SIAT ? <a href="connexion.php" class="main_menu_item">Se connecter</a>.
								</h4>
							</div>
						</div>
					</div>
